    ...
    public partial class InitialDataModel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TriviaGuesses", x => x.TriviaGuessId);
                    table.ForeignKey(
                        name: "FK_TriviaGuesses_ApplicationUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "ApplicationUserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TriviaGuesses_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TriviaGuesses_TriviaAnswers_TriviaAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TriviaGuesses_ApplicationUserId",
                table: "TriviaGuesses",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TriviaGuesses_EventId",
                table: "TriviaGuesses",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_TriviaGuesses_TriviaAnswerId",
                table: "TriviaGuesses",
