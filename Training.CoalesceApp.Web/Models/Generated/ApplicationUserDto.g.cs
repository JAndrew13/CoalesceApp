...
{
    public partial class ApplicationUserDtoGen : GeneratedDto<Training.CoalesceApp.Data.Models.ApplicationUser>
    {
        ...
        /// </summary>
        public override void MapFrom(Training.CoalesceApp.Data.Models.ApplicationUser obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(Training.CoalesceApp.Data.Models.ApplicationUser entity, IMappingContext context)
        {
            var includes = context.Includes;
        ...
        /// </summary>
        public override Training.CoalesceApp.Data.Models.ApplicationUser MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new Training.CoalesceApp.Data.Models.ApplicationUser()
            {
                Name = Name,
                Email = Email,
            };
