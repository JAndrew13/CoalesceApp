...
{
    public partial class TriviaAnswerDtoGen : GeneratedDto<Training.CoalesceApp.Data.Models.TriviaAnswer>
    {
        ...
        /// </summary>
        public override void MapFrom(Training.CoalesceApp.Data.Models.TriviaAnswer obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(Training.CoalesceApp.Data.Models.TriviaAnswer entity, IMappingContext context)
        {
            var includes = context.Includes;
        ...
        /// </summary>
        public override Training.CoalesceApp.Data.Models.TriviaAnswer MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new Training.CoalesceApp.Data.Models.TriviaAnswer()
            {
                Text = Text,
            };
